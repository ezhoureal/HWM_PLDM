...
class L1PolicyPlanner:
    ...
    def plan(
        ...
        try:
            ...
            subgoal_latents = subgoal_latents.to(self.device).detach()
            final_goal_latents = final_goal_latents.to(self.device).detach()
            ...
            dynamics_output = self.dynamics(
                ...
                action=normalized_actions.permute(1, 0, 2),
